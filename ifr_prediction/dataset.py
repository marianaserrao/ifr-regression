...
class Dataset_CRNN(data.Dataset):
    ...
    def __init__(self, exams, labels, frame_window=25, frame_step=2, transform=None):
        "Initialization"
        self.labels = labels
        self.exams = exams
    ...
    def read_images(self, exam, transform):
        X = []
    ...
    def __getitem__(self, index):
        ...
        # Load data
        X = self.read_images(exam, self.transform)     # (input) spatial images
